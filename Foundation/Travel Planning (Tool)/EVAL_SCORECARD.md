...
|---|---|---|---|---|---|---|
| Correct tools called for the query type (weather for weather questions, attractions for sightseeing, budget for cost questions) | 15 | 15 | 10 | 15 | 15 | 15 |
| No unnecessary tool calls (e.g. calling `estimate_budget` when no cost question was asked) | 10 | 10 | 5 | 10 | 10 | 5 |
| All implied tools called — complex queries (TC-03) trigger all three tools | 5 | 5 | 5 | 5 | 5 | 5 |
| **Subtotal** | /30 | **30** | **20** | **30** | **30** | **25** |
...
| Check | Points | TC-01 | TC-02 | TC-03 | TC-04 | TC-05 |
|---|---|---|---|---|---|---|
| Response directly answers the user's question (not generic filler) | 10 | 10 | 9 | 10 | 10 | 10 |
| Tool results are woven into a coherent narrative — not just repeated verbatim | 10 | 9 | 8 | 8 | 8 | 7 |
| Response is complete and not truncated (no mid-sentence endings) | 10 | 10 | 8 | 3 | 10 | 10 |
| Response uses appropriate formatting: headers, tables, or bullets where the content warrants it | 10 | 9 | 8 | 9 | 9 | 8 |
| **Subtotal** | /40 | **38** | **33** | **30** | **37** | **35** |
...
| Check | Points | TC-01 | TC-02 | TC-03 | TC-04 | TC-05 |
|---|---|---|---|---|---|---|
| Response is in markdown (not raw text or JSON) | 5 | 5 | 5 | 5 | 5 | 5 |
| Response length is appropriate to query complexity — not padded, not clipped | 10 | 9 | 6 | 5 | 9 | 7 |
| Tone is conversational and helpful, not robotic | 5 | 5 | 5 | 5 | 5 | 5 |
| **Subtotal** | /20 | **19** | **16** | **15** | **19** | **17** |
...
| Check | Points | TC-01 | TC-02 | TC-03 | TC-04 | TC-05 |
|---|---|---|---|---|---|---|
| Vague queries (TC-02: no month or style) produce a useful best-effort response, not an error or empty output | 5 | N/A | 3 | N/A | N/A | N/A |
| Niche destination (TC-04: Ulaanbaatar) is handled without hallucination or refusal | 5 | N/A | 5 | N/A | 5 | N/A |
| **Subtotal** | /10 | **10** | **8** | **10** | **10** | **10** |
...
|---|---|---|---|---|---|---|
| TC-01 | 30 | 38 | 19 | 10 | **97** | ✓ |
| TC-02 | 20 | 33 | 16 | 8 | **77** | ✓ |
| TC-03 | 30 | 30 | 15 | 10 | **85** | ✓ |
| TC-04 | 30 | 37 | 19 | 10 | **96** | ✓ |
| TC-05 | 25 | 35 | 17 | 10 | **87** | ✓ |
| **Average** | **27/30** | **34.6/40** | **17.2/20** | **9.6/10** | **88.4/100** | **5/5 ✓** |
